...
<body>
	...
	<ol class="breadcrumb">
	  ...
	  <li class="breadcrumb-item"><a href="manageBusiness.do">사업장관리</a></li>
	...
	<div class="container">
		...
		<div class="button">
			...
			<button type="submit" class="btn btn-primary" onclick="location.href='registerBP.do?no=${b.bp_no}'">승인</button>
