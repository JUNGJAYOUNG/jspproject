...
<hr>
	...
	<ol class="breadcrumb">
	  <li class="breadcrumb-item"><a href="#"><img src="image/home.png"></a></li>
	  <li class="breadcrumb-item active">문화배프</li>
	</ol>
		<nav style="position: relative; ">

		<select name="h_area2" id="h_area2"onChange="cat2_change(this.value)" class="form-select" style="width:100px; float:right; position: relative;" >
			<option>-선택-</option>
		</select>
		<select name="h_area1" id="h_area1" onChange="cat1_change(this.value,h_area2)" class="h_area1, form-select" style="width:100px; float:right; position: relative;">
			<option>-선택-</option>
