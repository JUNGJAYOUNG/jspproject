...
<jsp:include page="menu.jsp"/>
	...
	<div class="container">
		...
		<form action="addBusinessPlaceOK.do" method="post" enctype="multipart/form-data" name="BP">
			<table class="table table-hover">
				...
				<tr>
					...
					<td><input text="text" name="bp_name" placeholder="사업장 이름을 입력해주세요"  class="form-control" id="inputDefault"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="url" name="url" placeholder="URL을 입력해주세요" class="form-control" id="inputDefault"></td>
				</tr  class="table-active">
				<tr >
					<th class="table-success">사업장 전화번호</th>
					<td><input type="number"  name="tel1" oninput='handleOnInput(this, 4)'  style="width:100px;">-<input type="number" name="tel2" oninput='handleOnInput(this, 4)' style="width:100px;">-<input type="number" name="tel3" oninput='handleOnInput(this, 4)' style="width:100px;"></td>
				...
				<tr>
					...
					<td><input class="form-control" id="inputDefault" type="text" name="company" placeholder="주체를 입력해주세요" ></td>
				</tr>
				<tr>
					<th class="table-success">정보</th>
					<td><textarea rows="5" cols="60" name="info" class="form-control" id="exampleTextarea" placeholder="내용을 입력해주세요" style="resize: none;"></textarea></td>
				</tr>
				<tr>
					<th class="table-success">이미지 등록</th>
					<td><input type="file" class="form-control" name="uploadFile"></td>
				</tr>
				
			</table>
			<input type="button" value="등록" style="float: right;" class="btn btn-primary" onclick="checkBP()">
